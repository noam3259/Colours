...
public class FadeObjectBlockingObject : MonoBehaviour
{
    ...
    //    {
    //        if (this.gameObject.GetComponent<FadeObjectBlockingObject>().enabled == true)
    //        {
    //            StartCoroutine(CheckForObjects());
    //        }
    //    }
    ...
    private IEnumerator CheckForObjects()
    {
        ...
        while (true)
        {
            ////if the script is not enabled stop shading
            //if (this.gameObject.GetComponent<FadeObjectBlockingObject>().enabled==false)
            //{
            //    StopCoroutine(CheckForObjects());
            //}
